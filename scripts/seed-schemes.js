// Standalone Firestore Seed Script for Saarthi AI
// Run this script as: node scripts/seed-schemes.js
// Make sure to define Firebase environment variables or run in an environment where they are set.
...
async function seed() {
  if (!firebaseConfig.projectId) {
    console.error("Error: NEXT_PUBLIC_FIREBASE_PROJECT_ID environment variable is missing. Please create a .env.local file or set it in your environment.");
    process.exit(1);
  }
  ...
  await batch.commit();
  console.log("Successfully seeded 15 government schemes into the 'schemes' collection!");
  process.exit(0);
}
